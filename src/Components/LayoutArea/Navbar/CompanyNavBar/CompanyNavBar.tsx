...
const pages = [
  { label: 'My Details', path: 'company/companydetails' },
            ...
            >
              {pages.map((page) => (
                <MenuItem key={page.label} onClick={handleCloseNavMenu}>
                  <Typography component={NavLink} to={page.path} textAlign="center" variant="h6" noWrap sx={{ textDecoration: 'none', color: 'inherit' }}>
                    {page.label}
                  </Typography>
                </MenuItem>
              ))}
          ...
          <Box sx={{ flexGrow: 1, display: { xs: 'none', md: 'flex' } }}>
            {pages.map((page) => (
              <Button
                ...
                sx={{ my: 2, mx: 15, color: 'white', display: 'block', textTransform: 'none' }}
                component={NavLink}
                to={page.path}
              >
                {page.label}
